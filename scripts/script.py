...
input_path = project_dir / "input files" / "Advanced Hemos PAH Master Database (DS Copy).xlsx"
encrypted_output_path = project_dir / "output files" / "patients_first_two_RHCs_wide_ENCRYPTED.xlsx"
